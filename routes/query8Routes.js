...
router.get('/procedure/findPhoneByAddress/:subscriber_address_street', (req, res, next) => { 
    try {
...
// get phones by station
router.get('/phones_by_address/:subscriber_address_street', (req, res, next) => { 
    try {
...
router.get('/int_phones_by_building/:subscriber_address_street', (req, res, next) => { 
    try {
...
router.get('/int_phones_by_street/:street_name', (req, res, next) => { 
    try {
        connection.query(`SELECT COUNT(j.subscriber_first_name) 
                          FROM (SELECT s.subscriber_id, s.subscriber_first_name, s.subscriber_address_street, sf.subscriber_intercity_access 
                                FROM subscribers s 
